...
public interface IEntityTransformer {
	...
	INBT saveExternals(Entity entity);
	...
	short rotate(INBT nbtEntity, final byte rotationSteps, final float rotationYaw);
	...
	void restoreExternals(Entity entity, ITransformation transformation, INBT nbtBase);
}
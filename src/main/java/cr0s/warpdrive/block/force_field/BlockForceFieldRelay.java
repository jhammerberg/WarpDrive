...
public class BlockForceFieldRelay extends BlockAbstractForceField {
	...
	private static final VoxelShape AABB_RELAY = VoxelShapes.create(0.000D, 0.000D, 0.000D, 1.000D, 0.625D, 1.000D);
	...
	public ActionResultType onBlockActivated(@Nonnull final BlockState blockState, @Nonnull final World world, @Nonnull final BlockPos blockPos,
		...
		if (entityPlayer.isSneaking()) {
			...
			// validate type
			if (((ItemForceFieldUpgrade) itemStackHeld.getItem()).getUpgrade().maxCountOnRelay <= 0) {
			...
			final EnumForceFieldUpgrade enumForceFieldUpgrade = ((ItemForceFieldUpgrade) itemStackHeld.getItem()).getUpgrade();

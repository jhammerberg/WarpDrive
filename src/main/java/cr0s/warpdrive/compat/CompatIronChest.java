...
public class CompatIronChest implements IBlockTransformer {
	...
	public boolean isApplicable(final BlockState blockState, final TileEntity tileEntity) {
		return classBlockIronChest.isInstance(blockState.getBlock())
		    || classBlockIronShulkerBox.isInstance(blockState.getBlock());
	}
	...
	public BlockState rotate(final BlockState blockState, final CompoundNBT nbtTileEntity, final ITransformation transformation) {
		...
		if (nbtTileEntity.contains("facing")) {
			...
			case 1:
				nbtTileEntity.putByte("facing", rotFacing[facing]);
				break;
			case 2:
				nbtTileEntity.putByte("facing", rotFacing[rotFacing[facing]]);
				break;
			case 3:
				nbtTileEntity.putByte("facing", rotFacing[rotFacing[rotFacing[facing]]]);
				break;
			default:
				break;
			}

...
public class BlockForceFieldProjector extends BlockAbstractForceField {
	...
	private static final VoxelShape SHAPE_DOWN  = makeCuboidShape(0.00D, 0.27D, 0.00D, 1.00D, 0.73D, 1.00D);
	private static final VoxelShape SHAPE_UP    = makeCuboidShape(0.00D, 0.27D, 0.00D, 1.00D, 0.73D, 1.00D);
	private static final VoxelShape SHAPE_NORTH = makeCuboidShape(0.00D, 0.00D, 0.27D, 1.00D, 1.00D, 0.73D);
	private static final VoxelShape SHAPE_SOUTH = makeCuboidShape(0.00D, 0.00D, 0.27D, 1.00D, 1.00D, 0.73D);
	private static final VoxelShape SHAPE_WEST  = makeCuboidShape(0.27D, 0.00D, 0.00D, 0.73D, 1.00D, 1.00D);
	private static final VoxelShape SHAPE_EAST  = makeCuboidShape(0.27D, 0.00D, 0.00D, 0.73D, 1.00D, 1.00D);
		...
		if (entityPlayer.isSneaking()) {
			...
			if ( enumFacing == blockState.get(BlockProperties.FACING)
			  || ( tileEntityForceFieldProjector.isDoubleSided
				...
				tileEntityForceFieldProjector.setShape(EnumForceFieldShape.get(itemStackHeld.getDamage()));
				// shape mounted
